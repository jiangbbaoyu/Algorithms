...
public class Question01_searchRangeInSortedArray {

    /**
     * 在一个有序数组中，给定一个数target , 定位数组中大于等于target 的最左侧的元素的下标;
     * 要求时间复杂度O(logN ) ,只要时间复杂度为O(logN),要联想到二分查找
...
//            int middle = (left+right)/2;
     ...
     * 找出给定目标值 在数组中的开始位置和结束位置。如果数组中不存在目标值 target，返回 [-1, -1]
     *
